...
async function loadMasterData() {
    console.log('Loading Master Data from JSON...');

    const masterData = await loadJSON(CONFIG.masterJsonPath);

    NBHAS.masterData = masterData;

    NBHAS.sections = masterData.sections || [];
    NBHAS.symptoms = masterData.symptoms || [];
    NBHAS.categories = masterData.categories || [];
    NBHAS.recommendations = masterData.recommendations || [];
    NBHAS.resources = masterData.resources || [];
...
function calculateScores() {
    ...
    setTimeout(() => {
      ...
      renderDashboard(engineResults, "nbhas-app");
